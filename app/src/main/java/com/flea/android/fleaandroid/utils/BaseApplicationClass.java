...
public class BaseApplicationClass extends Application {
    ...
    public static final String TextViewDescription[] = {
            ...
            "외식 배달매장에 필요한\n" + "다양한 채널의 주문 조회 및 배달 대행 요청 서비스.\n\n" +
            "원터치로 신속, 정확하게 입력할 수 있는\n" + "POS 솔루션 입니다.\n" +
            "주문에서 배달까지 푸드테크 중개플랫폼으로\n" + "한방에 처리하고 관리합니다.\n\n" +
            "배달 POS와 연동되는 매장관리 Total 서비스를\n" + "스마트폰을 통해서 관리 할 수 있는,\n" +
            "사장님 전용 서비스를 제공합니다.",

            "마켓컬리는 맛있는 음식이\n" + "삶의 행복이라고 굳게 믿는 사람들끼리\n" + "뜻을 합쳐 만든 팀입니다.\n\n" +
            "비싼 식자재만이 좋은 음식일 것이라고\n" + "막연하게 생각하고 있는 소비자에게는\n" +
            "진짜 맛을 소개해드리고 싶었고,\n\n" + "뚝심 하나로 산골 오지에서\n" +
            "수십 년간 묵묵히 장을 담그는 명인,\n" + "시들어서 버릴지언정 무농약을 고집하는 농부에게는\n" +
            "안정적인 판매 활로를 찾아드리고 싶었습니다.\n"};
    public static final String TextViewHashTags[] = {"#개발 #디자인 #기획 #해커톤 #오픈소스", "#개발 #기획 #회계 #플랫폼", "#개발 #기획 #푸드 #유통 #디자인"};
